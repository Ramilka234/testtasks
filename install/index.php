...
class studyphpdevorg_cprop extends CModule
{
    var $MODULE_ID  = 'studyphpdevorg.cprop';
    ...
    function __construct()
    {
        ...
        $this->MODULE_ID = 'studyphpdevorg.cprop';
    ...
    function InstallDB()
    {
        ...
        AddEventHandler("iblock", "OnIBlockPropertyBuildList", ["studyphpdevorg\\CIBlockPropertyCProp",  "GetUserTypeDescription"]);

        // Для пользовательских полей
       // AddEventHandler("main", "OnUserTypeBuildList", ["studyphpdevorg\\UserFieldCProp", "GetUserTypeDescription"]);
    }

    function UnInstallDB()
    {
        UnRegisterModuleDependences("iblock", "OnIBlockPropertyBuildList", "studyphpdevorg.crop", "studyphpdevorg\\PropertyCProp", "GetUserTypeDescription");
       // UnRegisterModuleDependences("main", "OnUserTypeBuildList", "studyphpdevorg.crop", "studyphpdevorg\\UserFieldCProp", "GetUserTypeDescription");
    }
